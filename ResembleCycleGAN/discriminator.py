...
class Discriminator(nn.Module):
    def __init__(self, gaussian_noise_rate: float = 0.0) -> None:
        ...
        self.gaussianNoiseLayer = GaussianNoiseLayer(
            noise_rate=gaussian_noise_rate)

        self.conv1 = ConvBlock(3, 64, kernel_size=4,
                               stride=2, padding=1, use_norm=False)
        ...
        self.conv5 = ConvBlock(512, 1, kernel_size=4, stride=1,
                               padding=1, use_activation=False, use_norm=False)
